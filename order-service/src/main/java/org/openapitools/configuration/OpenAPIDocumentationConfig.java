...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .termsOfServiceUrl("")
            .version("v1.0.0")
            .contact(new Contact("","", "contact@anitechcs.com"))
            .build();
    }

    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.orderServiceAPISpecification.base-path:/v1}") String basePath) {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("com.anitechcs.orderservice.api"))
                    .build()
